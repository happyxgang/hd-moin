...
class Theme(ThemeBase):
    ...
    def header(self, d, **kw):
        ...
        html = [
            ...
            #changed self.interwiki(d),
            #changed self.title_with_separators(d),
            #u'</h1>',
            #self.trail(d),
            #changed self.navibar(d),
            #u'<hr id="pageline">',
            #u'<div id="pageline"><hr style="display:none;"></div>',
            self.msg(d),
            #changed self.editbar(d),
            #u'</div>',
